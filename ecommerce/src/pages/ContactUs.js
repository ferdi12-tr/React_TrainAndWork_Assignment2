                                        ...
                                        <div className="row">
                                            <div className="col-sm-4">
                                                <div className="single-contact-icon-text">
                                                    ...
                                                    <p className="single-contact-icon-text__value">Joseph, Canada 10020</p>
                                                </div>
                                            </div>
                                            <div className="col-sm-4">
                                                <div className="single-contact-icon-text">
                                                    ...
                                                    <p className="single-contact-icon-text__value">(012) 3456 7890</p>
                                                </div>
                                            </div>
                                            <div className="col-sm-4">
                                                <div className="single-contact-icon-text">
                                                    ...
                                                    <p className="single-contact-icon-text__value">info@website.com</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div className="contact-form-wrapper">
                                                    <form action="" method="">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-lg-12">
                                                                <textarea cols={30} rows={10} placeholder="Message *" name="contactMessage" id="contactMessage" required defaultValue={""} />
                                                            </div>
                                                            <div className="col-lg-12">
                                                                <button type="submit" id="submit" className="theme-button"> SEND A MESSAGE</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <div className="col-md-4">
                                                <div className="contact-form-content">
                                                    ...
                                                    <ul className="social-links">
                                                        ...
                                                        <li><a href="http://www.plus.google.com/"><i className="fa fa-google-plus" /></a></li>
                                                        <li><a href="http://www.linkedin.com/"><i className="fa fa-linkedin" /></a></li>
